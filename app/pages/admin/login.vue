...
<style scoped>
.admin-page{min-height:100vh;background:var(--bg);color:var(--text);display:grid;place-items:center;padding:24px}.admin-panel{width:min(450px,100%);padding:42px;border:1px solid var(--line);background:var(--surface)}.admin-panel>img{width:auto;height:36px;margin-bottom:65px}.admin-panel h1{font-size:55px;margin:15px 0 35px}.admin-panel form{display:grid;gap:16px}.admin-panel label{display:grid;gap:8px;color:var(--muted);font:13px "DM Mono";text-transform:uppercase}.admin-panel input{margin:0}.form-error{margin:0;color:var(--red-bright);font-size:14px}.home-link{display:flex;align-items:center;justify-content:center;gap:7px;margin-top:22px;color:var(--muted);font:14px "DM Mono";text-transform:uppercase}.home-link:hover{color:var(--red-bright)}
</style>
